        ...
        <aside className="w-72 h-full bg-white text-slate-800 border-e border-gray-200 shadow-sm flex flex-col z-20 overflow-hidden no-print">
            <div className="h-20 flex items-center px-6 border-b border-gray-100 justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-base font-bold tracking-tight text-slate-900">{dict?.Logo || "المحاسب الذكي"}</h1>
            ...
            <nav className="flex-1 p-4 space-y-1 mt-4 overflow-y-auto custom-scrollbar">
                ...
                {isAdmin && (
                    <>
                        ...
                        <SidebarItem href="/dashboard/employees" icon={<Users size={20} />} label={dict?.Sidebar?.Employees || "Employees"} onClick={onClose} />
                        <SidebarItem href="/dashboard/partners" icon={<Briefcase size={20} />} label={dict?.Sidebar?.Partners || "Partners"} onClick={onClose} />
                        <SidebarItem href="/dashboard/representatives" icon={<Briefcase size={20} />} label={dict?.Sidebar?.Representatives || "Representatives"} onClick={onClose} />
                ...
                <div className="space-y-4 px-2">
                    ...
                    <div className="p-3 rounded-xl flex items-center justify-between bg-slate-50/80 border border-slate-100 shadow-sm mx-1">
                        ...
                        <form action={async () => { await logout(); }}>
                            <button type="submit" className="text-slate-400 hover:text-red-500 transition-colors p-2 rounded-lg hover:bg-red-50" title={dict?.Sidebar?.Logout || "Logout"}>
                                <LogOut size={18} />
                            </button>
                        </form>
                    </div>
