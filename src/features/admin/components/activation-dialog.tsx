                    ...
                    <div className="p-8 pt-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                                <Label htmlFor="license-key" className={`text-sm font-bold text-slate-700 block ${dict?.Common?.Direction === 'rtl' ? 'text-right' : 'text-left'}`}>
                                    {dict?.Common?.EnterActivationKey}
                                </Label>
                                <Input
                                    id="license-key"
                            ...
                            <div className="bg-blue-50/80 p-4 rounded-2xl border border-blue-100 flex gap-4 items-start">
                                ...
                                <p className={`text-xs text-blue-800 font-semibold leading-relaxed ${dict?.Common?.Direction === 'rtl' ? 'text-right' : 'text-left'}`}>
                                    {dict?.Common?.SendHardwareIdHint}
                                </p>
                            </div>
                        </div>
                        ...
                        <DialogFooter className="mt-8 flex flex-row gap-3">
                            ...
                            >
                                {loading ? "..." : dict?.Common?.ActivateFullVersion}
                            </Button>
                        </DialogFooter>
                    </div>
                </DialogContent>
