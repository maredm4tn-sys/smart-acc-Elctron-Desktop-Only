...
export function PurchaseForm({ products, suppliers, initialProductId, initialData }: {
    ...
    const invoiceSchema = z.object({
        supplierId: z.string().min(1, dict.Suppliers.AddDialog.Errors.NameRequired), // Use ID for Supplier
        ...
        items: z.array(z.object({
            ...
            unitCost: z.number().min(0, dict.Sales.Invoice.Form.Errors.PriceRequired),
